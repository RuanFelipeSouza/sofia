    ...
    <MaterialTable
      ...
      editable={{
        onRowAdd: async (newData) => {
          ...
          await api.post("/addClient", { client: newData });
        },
        ...
        onRowDelete: async (oldData) => {
          try {
            await api.delete("/removeClient/" + oldData._id);
            props.setClients((prevState) => {
              const data = prevState;
            ...
            alert('O cliente possui processos ativos, por isso não é possível deletá-lo. Os processos são:\n' + e.response.data.join('\n'));
          }
        },
      }}
    />
