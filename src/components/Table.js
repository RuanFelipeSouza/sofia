...
export default function Table(props) {
  const _renderUnderstood = ({ understood }) =>
    understood ? (
      <ThumbUpRoundedIcon style={{ color: '#4caf50' }} />
    ) : (
      <ThumbDownRoundedIcon style={{ color: '#f44336' }} />
    );
  const _renderLink = ({ _id }) => (
